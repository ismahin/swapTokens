...
contract TokenSwapper {
    ...
    address private constant WBTC = 0x577D296678535e4903D59A4C929B718e1D575e0A; // Ensure this is checksummed too
    address private constant USDC = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48; // Ensure this is checksummed too
    ...
    function swapWBTCtoUSDC(uint _wbtcAmount) public {
        ...
        uniswapRouter.swapExactTokensForTokens(_wbtcAmount, amountOutMin, path, msg.sender, deadline);
    }
}
